      ...
      <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-stone-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 sm:h-20">
            ...
            >
              <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-navy-900 flex items-center justify-center text-gold-400 shadow-md group-hover:scale-105 transition-transform">
                <Church className="w-6 h-6 text-gold-400" />
              </div>
              <div>
                <h1 className="text-base sm:text-lg font-bold text-navy-950 font-serif leading-tight">
                  {t.appName}
                </h1>
                <p className="text-[11px] sm:text-xs text-church-600 font-medium">
                  {t.churchName}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2.5">
              ...
              <button
                ...
                className="relative p-2 rounded-xl border border-stone-200 hover:bg-stone-100 text-stone-700 transition"
                title={t.notifications.title}
              >
                <Bell className="w-5 h-5" />
                {unreadNotificationsCount > 0 && (
                  <span className="absolute -top-1 -right-1 flex items-center justify-center w-5 h-5 text-[10px] font-bold text-white bg-rose-600 rounded-full border-2 border-white animate-pulse">
                    {unreadNotificationsCount}
                  </span>
                )}
              </button>
              ...
              <div className="hidden sm:flex items-center gap-2.5 ps-2 border-s border-stone-200">
                ...
                <div className="text-start">
                  ...
                  <Badge role={currentUser.role} size="sm" className="mt-0.5" />
                </div>
              </div>
              ...
              <button
                ...
                className="md:hidden p-2 rounded-lg border border-stone-200 text-stone-700 hover:bg-stone-100"
              >
