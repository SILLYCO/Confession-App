...
export interface Translations {
  ...
  priestFlow: {
    ...
    useDefaultDuration: string;
    windowSlotsCount: string;
...
const translations: Record<Language, Translations> = {
  en: {
    ...
    priestFlow: {
      ...
      avgDurationLabel: "Baseline Default Confession Duration",
      avgDurationHelper: "Default session duration inherited by new availability windows (e.g. 15, 20, 30 min). You can also customize the duration for each individual day below.",
      windowDurationLabel: "Day Session Duration",
      useDefaultDuration: "Inherit Default",
      windowSlotsCount: "Slots",
  ...
  ar: {
    ...
    priestFlow: {
      ...
      avgDurationLabel: "متوسط مدة الاعتراف الافتراضي العام (بالدقائق)",
      avgDurationHelper: "المدة الأساسية الافتراضية لجلسة الاعتراف. يمكنك أيضاً تخصيص مدة أطول أو أقصر لكل يوم محدد أدناه بشكل منفصل.",
      windowDurationLabel: "مدة الاعتراف لهذا اليوم",
      useDefaultDuration: "الافتراضي العام",
      windowSlotsCount: "موعداً",
