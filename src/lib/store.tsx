    ...
    try {
      ...
      if (userData.role === 'priest') {
        const newProfile: PriestProfile = {
          ...
          schedule_overrides: [],
          church_name_ar: priestProfileData?.church_name_ar || 'كنيسة الشهيد العظيم مارجرجس والأنبا أنطونيوس',
          church_name_en: priestProfileData?.church_name_en || 'St. George & St. Anthony Coptic Orthodox Church',
          bio_ar: priestProfileData?.bio_ar || 'كاهن ومرشد روحي بكنيسة الشهيد العظيم مارجرجس.',
          bio_en: priestProfileData?.bio_en || 'Parish priest & spiritual counselor at St. George Church.',
          created_at: new Date().toISOString(),
        };
